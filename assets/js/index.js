...
function Cinema() {
    window.location.href = "https://github.com/AliAbuAbid/CoffeShop";
}
...
function BestRent() {
    window.location.href = "https://github.com/AliAbuAbid/BestRent-FP";
}

function CV(){
    window.location.href="CV-Ali Abu Abid.pdf";
}